...
//vet inte om vi ska ha tangenter, mus samt joystick(ratt) eller bara delar av det
class InputManager :
...
public:
	...
	//vad är grejen med flera joysticks? multiplayer?
...
private:
	...
	//eeh, antar att detta lär göras om till att passa en ratt?
